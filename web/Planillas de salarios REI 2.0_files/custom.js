 ...
 */
  ...
  /**
    ...
    function calcularDias(){
		var fechaEmpresa=document.getElementById("fechaEmpresa").value;
		...
		if(validate_fecha(fechaInicial) && validate_fecha(fechaFinal))
		{
			...
			empresa =fechaEmpresa.split("-");
			inicial=fechaInicial.split("-");
			final=fechaFinal.split("-");
			//alert('e:'+empresa+' fi:'+inicial+' ff:'+final);
			/*  
			e:06,07,2018 fi:01,10,2018 ff:08,10,2018  
			Mon Oct 01 2018 00:00:00 GMT-0400  <----> Mon Oct 08 2018 00:00:00 GMT-0300 (Hora de verano de Paraguay)
			*/
			// obtenemos las fechas en milisegundos
            var dataEmpresa =new Date(empresa[2],(empresa[1]-1),empresa[0]);
         ...
         if(dataEmpresa<=dateStart){
				if(dateStart<=dateEnd){
					...
					//alert(resultado);
					var aux = Math.round((((dateEnd-dateStart)/86400)/1000));
					//alert(aux);
				...
				alert("La fecha inicial no puede ser menor \n a la fecha de ingreso a la empresa");
				document.getElementById("fechaInicio").value=fechaEmpresa;
			}		
		}else{
